...
from inpaint_utils import get_human_cfg, get_robot_cfg, get_segmentation_model, get_inpaint_model, inpaint
...
if __name__ == '__main__':
    ...
    # load in models
    human_cfg = get_human_cfg()
    robot_cfg = get_robot_cfg()
    human_segmentation_model = get_segmentation_model(human_cfg)
    ...
    logdir = 'inpaint_' + logdir + f'_{TIMESTEPS}_{N_SAMPLES}_{NUM_ITERATIONS}_task{args.task_id}'
