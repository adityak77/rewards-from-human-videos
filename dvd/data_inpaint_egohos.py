...
def main(args):
    ...
    output_path = os.path.join(args.human_data_dir, '20bn-something-something-v2-inpainted-egohos-e2fgvi_hq')
...
if __name__ == '__main__':
    ...
    # --model e2fgvi_hq --ckpt /home/akannan2/inpainting/E2FGVI/release_model/E2FGVI-HQ-CVPR22.pth \\
    args = get_args()
    main(args)
