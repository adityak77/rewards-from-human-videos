...
class NextFrameSv2p(base.NextFrameBase, base_vae.NextFrameBaseVae):
  ...
  def bottom_part_tower(self, input_image, input_reward, action, latent,
    ...
    enc0 = tfl.conv2d(
        ...
        padding="SAME",
        name="scale1_conv1")
    enc0 = tensorflow.keras.layers.LayerNormalization()(enc0)
    ...
    hidden1 = tensorflow.keras.layers.LayerNormalization()(hidden1)
    layer_id += 1

    hidden2, lstm_state[layer_id] = lstm_func(
        hidden1, lstm_state[layer_id], lstm_size[layer_id], name="state2")
    hidden2 = tensorflow.keras.layers.LayerNormalization()(hidden2)
    ...
    if self.hparams.small_mode:
      ...
      hidden3 = tensorflow.keras.layers.LayerNormalization()(hidden3)
      layer_id += 1
      ...
      hidden4 = tensorflow.keras.layers.LayerNormalization()(hidden4)
    ...
    hidden5 = tensorflow.keras.layers.LayerNormalization()(hidden5)
  ...
  def reward_prediction_big(
    ...
    with tf.variable_scope("reward_pred", reuse=tf.AUTO_REUSE):
      ...
      x = tensorflow.keras.layers.LayerNormalization()(x)
  ...
  def construct_predictive_tower(
    ...
    with tf.variable_scope("main", reuse=tf.AUTO_REUSE):
      ...
      hidden6 = tensorflow.keras.layers.LayerNormalization()(hidden6)
      # Skip connection.
      ...
      hidden7 = tensorflow.keras.layers.LayerNormalization()(hidden7)
      layer_id += 1
      ...
      with tf.variable_scope("upsample3", reuse=tf.AUTO_REUSE):
        enc6 = common_layers.cyclegan_upsample(
            ...
            stride=[2, 2], method=upsample_method)
      enc6 = tensorflow.keras.layers.LayerNormalization()(enc6)
